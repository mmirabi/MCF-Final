<html>
    <head>        
        <style>
            /*! CSS Used from: https://www.ribbonflowers.com/assets/bundle.css?v=2936 */
            .fa {
            ...
            *:focus {
            ...
            /*! CSS Used from: https://www.ribbonflowers.com/assets/stylenewe.css?v=2936 */
            .sepetozetsecond {
                vertical-align: top;
                padding-bottom: 8px;
                font-size: 12px;
            ...
            .sepetsil {
                ...
                width: 16px;
                height: 19px;
                background-image: URL('../ikonlar/trash.png');
                background-repeat: no-repeat;
                cursor: pointer;
            }
            ...
            .kuponLi1 {
                ...
                border-top: 1px solid #ddd;
                margin-bottom: 15px;
                background-image: URL('../ikonlar/hediye.png');
            ...
            .yeniadresekle {
                ...
                padding: 5px;
                margin-top: 27px;
                background-image: url('https://www.ribbonflowers.com/ikonlar/Plus.png');
            ...
            .hazirbuton {
                ...
                padding-left: 70px;
                padding-right: 50px;
                background-image: url(https://www.ribbonflowers.com/ikonlar/notlar.png);
                background-repeat: no-repeat;
            ...
            [type=checkbox]:checked+label:before {
                content: '';
                background: url('https://www.ribbonflowers.com/images/checked.png');
