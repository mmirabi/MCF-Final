...
<table class="table mt-4 bg-white">
    <tbody>
        ...
        <tr
            class="collapse"
            id="collapse-shipping-method-shippo"
        >
            <td
                class="border-left"
                colspan="3"
                    ...
                    <div class="col-sm-6">
                        <ul>
                            ...
                            <li class="text-secondary">
                                <p>{{ trans('plugins/shippo::shippo.configuration_requirement', ['name' => 'Shippo']) }}:
                                </p>
                                <ul class="ms-3 ps-2">
                                    <li style="list-style-type: decimal">
                                        <p>
                                            <a
                                                href="https://apps.goshippo.com/join"
                                                target="_blank"
                                            >
                                    ...
                                    <li style="list-style-type: decimal">
                                        <p>{{ trans('plugins/shippo::shippo.after_service_registration_msg', ['name' => 'Shippo']) }}
                                        </p>
                                    </li>
                                    <li style="list-style-type: decimal">
                    ...
                    <div class="col-sm-6">
                        <div class="well">
                            ...
                            <div class="form-group mb-3">
                                <label
                                    class="control-label"
                                    for="shipping_shippo_cache_response"
                                >
