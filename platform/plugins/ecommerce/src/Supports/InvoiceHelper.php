    ...
    public function store(Order $order)
    {
        ...
        foreach ($order->products as $orderProduct) {
            $invoice->items()->create([
                ...
                'additionals' => $orderProduct->additionalProducts()->toArray(),
                'shipping_rule' => $orderProduct->shippingRule->toArray(),
                'shipping_date' => $orderProduct->shipping_date,
                'shipping_time' => $orderProduct->shipping_time,
                'shipping_price' => $orderProduct->shipping_price,
                'additional_price' => $orderProduct->additional_price,
                'message_text' => $orderProduct->message_text,
                'message_sender' => $orderProduct->message_sender,
                'recipient_name' => $orderProduct->recipient_name,
                'recipient_phone' => $orderProduct->recipient_phone,
                'recipient_address' => $orderProduct->recipient_address,
                'sub_total' => $orderProduct->price * $orderProduct->qty + $orderProduct->additional_price,
