...
return new class () extends Migration {
    ...
    {
        if (!Schema::hasColumns('ec_invoice_items', ['additional_id', 'city_id', 'send_at', 'message_subject', 'message_text'])) {
            Schema::table('ec_invoice_items', function (Blueprint $table) {
                $table->string('additional_id')->after('reference_id')->nullable();
                ...
                $table->decimal('shipping_price', 15)->after('price')->nullable();
            });
        }
    }
